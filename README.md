...
- `compileJava` passed.
- `runGameTestServer` passed with 144 required GameTests.
- `clean build` passed and produced `build/libs/engineers_decor_reforged-1.1.6-reconstructed.jar`.
- Latest rebuilt jar observed locally: `2,468,656` bytes, updated `2026-06-17 6:16:18 PM`.
