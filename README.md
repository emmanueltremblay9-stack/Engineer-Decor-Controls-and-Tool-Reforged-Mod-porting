...
- `compileJava` passed.
- `runGameTestServer` passed with 145 required GameTests.
- `clean build` passed and produced `build/libs/engineers_decor_reforged-1.1.7-reconstructed.jar`.
- Latest rebuilt jar observed locally: `2,469,000` bytes, updated `2026-06-17 6:31:40 PM`.
